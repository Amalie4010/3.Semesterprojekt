namespace communication.Communication.Nodes
{
    ...
    {
        /***********
         THIS CLASS HOLDS ALL NODES FOR THE MACHINE WITH NAMESPACES FOR IT
         ***********/
    ...
    public static readonly OpcNode<int> ProdProcessedCount = new("ns=6;s=::Program:Cube.Admin.ProdProcessedCount");
    ...
    public static readonly OpcNode<float> BatchId = new("ns=6;s=::Program:batch_id");
    ...
    public static readonly OpcNode<int> ProdProcessedCount2 = new("ns=6;s=::Program:Cube.Admin.ProdProcessedCount");
    public static readonly OpcNode<int> ProdDefectiveCount2 = new("ns=6;s=::Program:Cube.Admin.ProdDefectiveCount");
    public static readonly OpcNode<int> StopReasonId = new("ns=6;s=::Program:Cube.Admin.StopReason.Id");
    public static readonly OpcNode<int> StopReasonValue2 = new("ns=6;s=::Program:Cube.Admin.StopReason.Value");
    public static readonly OpcNode<float> AdminParameter0 = new("ns=6;s=::Program:Cube.Admin.Parameter[0].Value");
    
    
    public static readonly OpcNode<int> StateCurrent2 = new("ns=6;s=::Program:Cube.Status.StateCurrent");
    public static readonly OpcNode<float> MachSpeed2 = new("ns=6;s=::Program:Cube.Status.MachSpeed");
    public static readonly OpcNode<float> CurMachSpeed2 = new("ns=6;s=::Program:Cube.Status.CurMachSpeed");
    public static readonly OpcNode<float> StatusParameter0 = new("ns=6;s=::Program:Cube.Status.Parameter[0].Value");
    public static readonly OpcNode<float> StatusParameter1 = new("ns=6;s=::Program:Cube.Status.Parameter[1].Value");
    public static readonly OpcNode<float> StatusParameter2 = new("ns=6;s=::Program:Cube.Status.Parameter[2].Value");
    public static readonly OpcNode<float> StatusParameter3 = new("ns=6;s=::Program:Cube.Status.Parameter[3].Value");
    public static readonly OpcNode<float> StatusParameter4 = new("ns=6;s=::Program:Cube.Status.Parameter[4].Value");
    }
}

...
class LoginController extends Controller
{
     ...
     public function login(Request $request): RedirectResponse
    {
        ...
        // "Auth::attempt($credentials)" checks if a user with that email exists and teh corresponding hash password matches, laravel automatically compares the entered password with the bcrypt hash (encrypted password), in the table
